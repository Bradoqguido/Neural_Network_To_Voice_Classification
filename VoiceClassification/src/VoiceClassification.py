...
# 40 speakers each speaker count like a class
...
history = model.fit(X_trainData, y_trainData, batch_size=256, epochs=100, validation_data=(X_validationData, y_validationData), callbacks=[early_stop])
